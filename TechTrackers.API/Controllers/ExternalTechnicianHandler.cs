...
namespace TechTrackers.API.Controllers
{
    ...
    [ApiController]
    public class ExternalTechnicianHandler : ControllerBase
    {
        private readonly ExternalTechnicianService _technicianservice;

        public ExternalTechnicianHandler(ExternalTechnicianService technicianService)
        {
            _technicianservice = technicianService;
        }

        [HttpPost("add")]
        public IActionResult AddExternalTechnician([FromBody] TechnicianDto technicianDto)
        {
            ...
            try
            {
                _technicianservice.AddExternalTechnician(technicianDto);
        ...
        [HttpGet]
        public IActionResult GetExternalTechnicians()
        {
            try
            {
        ...
        [HttpGet("{id}")]
        public IActionResult GetExternalTechnician(int id)
        {
            try
            {
