    ...
    public class TechnicianService
    {
        ...
        public void AddTechnician(TechnicianDto technicianDto)
        {
            ...
            var user = new User
            {
                ...
                RoleId = technicianDto.TechnicianType == "external" ? 5 : 3 // Different role for external
            };
            ...
            var technician = new Technician
            {
                ...
                TechnicianType = technicianDto.TechnicianType,
        ...
        public List<TechnicianDto> GetAllTechnicians()
        {
            var technicians = _context.Technicians
                ...
                .Select(t => new TechnicianDto
                {
                    ...
                    Contacts = t.Contacts,
                    TechnicianType = t.TechnicianType, // Add this line
                    Location = t.Location // Add this line
                }).ToList();
        ...
        public TechnicianDto? GetTechnicianById(int technicianId)
        {
            ...
            return new TechnicianDto
            {
                ...
                TechnicianType = technician.TechnicianType, // Add this
                Location = technician.Location // Add this
            };
        }
